...
Em 2026-07-19 foram implementados, commitados, **pushados e deployados** três ciclos de correção derivados da auditoria frontend de 2026-07-18 (`docs/FRONTEND_AUDIT_2026-07-18.md`, relatório da Kimi auditado pelo Claude): galeria de cartazes individuais no Aprendi Vivendo (A1, commit `218f818`), contraste AA + alvos de toque (A2/A3, `7c72329`) e redirect legado de ensaios + labels de players (A5/A7 parcial, `58b0e76`). Deploy verificado em produção (`aprendi-vivendo-ep1.jpg` responde 200). Sobre o cache de 1 dia de `/css/*`: a página do Aprendi Vivendo fura o cache via `?v=20260719-1`; as demais páginas se curam em até 24h para visitantes recorrentes.
