...
Essa aproximação fica mais concreta quando escolhemos obras específicas. Em [*Sayonara Wild Hearts*, da Simogo](https://simogo.com/work/sayonara-wild-hearts/), cada fase corresponde a uma canção de sua trilha pop. Segundo os desenvolvedores, a ação acompanha as variações de cada faixa. A relação entre música, movimento, câmera e expectativa oferece um caminho para aproximar essa experiência da de um videoclipe. É um caso particular que ajuda a testar a comparação.
